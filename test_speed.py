...
target_ip = "xy.xy.xy.xy"  # Replace with your target IP address
username = os.getenv('SENTINEL_DEFAULT_USERNAME', 'user')  # Replace with your username 
password = os.getenv('SENTINEL_DEFAULT_PASSWORD', 'pass')  # Replace with your password 
simple_script = """
